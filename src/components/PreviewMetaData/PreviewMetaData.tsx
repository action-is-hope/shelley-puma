...
export const Google = ({
  ...
  <article className={classnames(classes.previewItem, classes.google)}>
    <Icon
      viewBox="0 0 272 92"
    ...
    <aside className={classes.googleListing}>
      <p className={classnames(classes.singleLineTruncate, classes.googleUrl)}>
        {slug}
      </p>
      <p
        className={classnames(classes.singleLineTruncate, classes.googleTitle)}
      >
        {title}
      </p>
      <p
        className={classnames(
          classes.googleDescription,
          classes.multiLineTruncate
        )}
      >
        {description}
      </p>
...
export const Twitter = ({
  ...
  <article className={classnames(classes.previewItem, classes.twitter)}>
    <Icon
      viewBox="0 0 400 400"
    ...
    <aside className={classes.twitterListing}>
      ...
      <div className={classes.twitterText}>
        <p
          className={classnames(
            classes.singleLineTruncate,
            classes.twitterTitle
          )}
        >
          {title}
        </p>
...
export const Facebook = ({
  ...
  <article className={classnames(classes.previewItem, classes.facebook)}>
    <Icon
    ...
    <aside className={classes.facebookListing}>
      <header className={classes.facebookTextBox}>
        {image && <img className={classes.facebookImage} src={image} alt="" />}
        <p
          className={classnames(
            classes.singleLineTruncate,
            classes.facebookDomain
          )}
        >
          {domain}
        </p>
...
const PreviewMetaData = React.forwardRef(
  (
    {
